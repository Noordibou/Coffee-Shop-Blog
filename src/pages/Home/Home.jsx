    ...
    <>
      <div>
        <main className="bg-gray-100 min-h-screen">
          ...
          <h2 className="text-2xl font-bold mx-auto mt-8 px-4 md:pl-8">Coffee Shop Listings</h2>
          <div className="container mx-auto px-4 mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {coffeeShop.map((shop) => {
        ...
        <footer className="py-4 bg-bodyColor text-white text-center">
